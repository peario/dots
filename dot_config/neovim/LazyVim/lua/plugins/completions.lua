...
return {
  -- NOTE: uncommenting this will hide completions
  {
    "saghen/blink.cmp",
    opts = {
      cmdline = {
  ...
  },
  {
    ...
    opts = function()
      ...
      -- Snippets written as compatible with VSCode (in json format)
      require("luasnip.loaders.from_vscode").lazy_load({
        lazy_paths = { vim.fn.stdpath("config") .. "/snippets/vscode" },
        exclude = { "latex" },
      })

      -- Snippets written with snipmate format
      require("luasnip.loaders.from_snipmate").lazy_load({
        lazy_paths = { vim.fn.stdpath("config") .. "/snippets/snipmate" },
      })

      -- Snippets written in lua
      require("luasnip.loaders.from_lua").lazy_load({
        lazy_paths = { vim.fn.stdpath("config") .. "/snippets/lua" },
      })
  ...
  --     })
  --
  --     -- Use cmdline & path source for `:` (if `native_menu` is enabled, won't work)
  --     cmp.setup.cmdline(":", {
  --       mapping = cmp.mapping.preset.cmdline(),
  --       sources = cmp.config.sources({
  --         { name = "path" },
